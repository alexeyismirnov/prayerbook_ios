...
class SynaxarionModel : EbookModel, PreachmentModel {
    ...
    func getPreachment(_ date: Date) -> [Preachment] {
        ...
        dates = [
            ...
            cal.pascha+21.days, cal.pascha+24.days,cal.pascha+28.days,cal.pascha+35.days,
            cal.pascha+42.days,cal.pascha+39.days,cal.pascha+49.days, cal.pascha+50.days, cal.pascha+56.days,
        ]
