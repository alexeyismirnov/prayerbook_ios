...
struct FeastNotifications {
    ...
    static func addNotification(date: Date, title: String, body: String, before: Bool = true) {
    ...
    static func saintNotification(date: Date, body: String) {
        ...
        addNotification(date: date, title: "", body: "\(d) - \(body)", before: false)
    }
        ...
        center.requestAuthorization(options:  [.alert, .sound]) {
            ...
            if granted {
                ...
                for (date, descr) in FeastList.shortFasts {
                    addNotification(date: date, title:  "День постный", body: descr.string)
                }
                
                for (date, descr) in FeastList.fastFreeWeeks {
                    addNotification(date: date, title: "Сплошная седмица, поста нет", body: descr.string)
                }
